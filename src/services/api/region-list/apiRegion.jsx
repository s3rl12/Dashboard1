...
const apiRegion = axios.create({
    baseURL: `http://${apiIp}/api/ges_areas/region`, // Se establece la base URL específica para /region
    timeout: 60000,
    headers: {
...
apiRegion.interceptors.request.use(
    (config) => {
...
apiRegion.interceptors.response.use(
    (response) => response,
    (error) => {
