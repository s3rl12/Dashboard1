...
const apiImportUser = axios.create({
    baseURL: `http://${apiIp}/api/ges_user/import-user`,
    timeout: 60000,
    headers: {
...
apiImportUser.interceptors.request.use(
    config => {
...
apiImportUser.interceptors.response.use(
    response => response,
    error => {
