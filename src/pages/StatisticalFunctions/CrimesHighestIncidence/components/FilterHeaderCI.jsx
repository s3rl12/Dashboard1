...
export default function FilterHeaderCI({
    containerIds = [],
    useCargaHook,
    // Se elimina taxPdfComponent y taxPdfData, y la prop cantidadDelitos
}) {
    ...
    // Nuevos estados para los inputs de cantidad delitos y cantidad años
    ...
    // Actualización del objeto de parámetros: se renombra id_sede a id_sedes y se agregan cantidadDelitos y cantidadAnio
        ...
        <div className="space-y-2">
            ...
            <div className="block md:flex md:items-center md:justify-between">
                <div className="flex items-center w-full gap-2">
                    ...
                    {/* Nuevos inputs para cantidad delitos y cantidad años */}
                    <Input
                        className="w-48"
            ...
            {/* Se mantiene el Dialog para previsualizar PDF generado con html2canvas/jsPDF si se desea */}
