 ...
 */
export default function DeadlineHeaderC({
    generalSede = {},
    code_barras,
    reportType = "S",
    headerTitle = "",
        ...
        <div className="border-b border-tremor-border py-2 dark:border-dark-tremor-border">
            ...
            <div className="flex flex-row gap-3 w-full px-3">
                <Metric
                    ...
                    value={generalSede.Cantidad_Plazos ?? 0}
                    IconComponent={IconFileText}
                />
                <Metric
                    label="Cantidad de fiscales"
                    value={generalSede.Cantidad_Fiscales_Ultimo_Mes ?? 0}
                    IconComponent={IconUser}
                />
                <Metric
                    label={thirdLabel}
                    value={generalSede.Cantidad_Dependencias ?? 0}
