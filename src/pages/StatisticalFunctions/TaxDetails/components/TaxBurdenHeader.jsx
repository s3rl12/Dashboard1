  ...
  return (
    <div className="border-tremor-border dark:border-dark-tremor-border py-2">
      <div className="flex flex-row w-full justify-around items-center">
        ...
        <Metric label="Cantidad total de casos ingresados" value="1250" IconComponent={IconFileSymlink} />
        <Metric label="Cantidad de casos ingresados del mes" value="1250" IconComponent={IconCalculator} />
        <Metric label="Cantidad total de casos resueltos" value="1250" IconComponent={IconClipboardText} />
        <Metric label="Cantidad de casos resueltos del mes" value="1250" IconComponent={IconGavel} />
        <Metric label="Meta del mes" value="12" IconComponent={IconUserEdit} />
      </div>
    </div>
  );
}
