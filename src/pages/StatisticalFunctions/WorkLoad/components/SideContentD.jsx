...
export default function SideContentD({ workspaces = [], onCardClick }) {
    return (
        <div className="grid grid-cols-1 gap-4">
            {workspaces.map((workspace, index) => (
                ...
                >
                    ...
                    {/* Sección con código, número de fiscales, estado y codeD */}
                    <div className="mt-2 flex flex-wrap items-center gap-3">
                        ...
                        <span className="text-sm text-tremor-content dark:text-dark-tremor-content">
                            Code dependencia: <strong>{workspace.codeD}</strong>
                        </span>
                    </div>
                </Card>
            ))}
